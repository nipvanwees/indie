...
import { Sidebar, SidebarDivider, SidebarHeader, SidebarItem } from "./ui/sidebar";
import { Button } from "./ui/button";
import { Dialog, DialogTitle, DialogBody } from "./ui/dialog";
import { CreateWorkout } from "../trainer/_components/workout/CreateWorkout";
...
export const SideBar = () => {
    ...
    return (
      <Sidebar>
        ...
        <SidebarDivider />
        <SidebarHeader>Workout</SidebarHeader>
        <SidebarItem href={"/workouts"}>
          Show all workouts
        </SidebarItem>
        <SidebarItem
          onClick={() => {
